...
- [Mickeyy (The micromouse)](#mickeyy-the-micromouse)
  - [Table of Contents](#table-of-contents)
  - [1. Project Overview](#1-project-overview)
  - [2. Hardware Platform](#2-hardware-platform)
  - [3. Firmware Architecture](#3-firmware-architecture)
    - [3.1 Shared State (`SharedMemory.hpp`)](#31-shared-state-sharedmemoryhpp)
    - [3.2 Low-Level Drivers](#32-low-level-drivers)
    - [3.3 PID Control (`PIDController.hpp`)](#33-pid-control-pidcontrollerhpp)
    - [3.4 Motion Primitives (`MovementController.hpp`)](#34-motion-primitives-movementcontrollerhpp)
    - [3.5 Main Control Loop (`mickeyy.ino`)](#35-main-control-loop-mickeyyino)
  - [4. Vision \& Path-Planning Pipeline](#4-vision--path-planning-pipeline)
    - [4.1 Fixed-Grid Maze Planner – `fixedGridPlanner.ipynb`](#41-fixed-grid-maze-planner--fixedgridplanneripynb)
    - [4.2 Continuous Task Planner – `continousTaskPlanner.ipynb`](#42-continuous-task-planner--continoustaskplanneripynb)
  - [5. Example Run](#5-example-run)
  - [6. End-to-End Data Flow](#6-end-to-end-data-flow)
  - [7. Getting Started](#7-getting-started)
    - [7.1 Firmware](#71-firmware)
    - [7.2 Vision \& Planning](#72-vision--planning)
